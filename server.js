...
// MCP SDK: server + legacy SSE transport (works with Custom Connector)
...
/* ---------------- Legacy SSE transport endpoints ----------------
   Matches the SDK’s backwards-compat pattern:
   GET /sse       -> opens SSE stream
   POST /messages -> receives client → server messages
-----------------------------------------------------------------*/
